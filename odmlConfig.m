...
% Function calls:
%
% odmlConfigtries to import the required libraries into the
% workspace while using the current working directory, respectively search
% path.
%
%
...
clear path; clear indices; clear workDir;